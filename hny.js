...
function myMessage() {
  ...
  yesBtn.addEventListener("click", () => {
    ...
    read.innerHTML =
      "<b>Happy New Year so much!</b><br><br>Thank you for being part of my 2024. Angas ng discord server dahil nakilala kita. Thank you for being by my side (not physically) sa not so okay na part ng buhay ko. I really appreciate you. Thank you for always offering kahit na alam mong hihindi ako. Thank you for stressing dahil sa'kin HAHAHA. I know na ayaw mo maging ganoon pero nag-iisip ka pa rin for me. Thank you for making time noong umuwi ka and for taking care of me nung lasingan time. Thank you for not treating me like a burden or what. Thank you so much, rowl! Sobrang natutuwa talaga akong nakilala ko kayo, ikaw. Kaya maangas pa rin 2024 ko despite ng mga nangyari. I really hope that we'll always be in touch kahit pa magkajowa ka in the future. P'wede mo ko i-block kapag nangyari 'yon. Add mo na lang ako kapag nag-break kayo. Sharot HAHAHAHA. Ayon, hampy new year ser hehe. Sana maging maangas ang bagong tao for us. <br><br><b>L8ter,<br>Shy</b>";
